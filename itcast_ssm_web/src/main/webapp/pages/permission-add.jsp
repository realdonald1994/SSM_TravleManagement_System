...
<link rel="stylesheet"
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				Authority Management <small>Authority Form</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> Home</a></li>
				<li><a href="${pageContext.request.contextPath}/role/findAll.do">Authority Management</a></li>
				<li class="active">Authority Form</li>
			</ol>
			</section>
			<!-- 内容头部 /-->
			...
			<form action="${pageContext.request.contextPath}/permission/save.do"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-2 title">Authority Name</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="permissionName"
								placeholder="Authority Name" value="">
						</div>
						<div class="col-md-2 title">Authority Range</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="url"
								placeholder="Authority Range" value="">
						</div>
