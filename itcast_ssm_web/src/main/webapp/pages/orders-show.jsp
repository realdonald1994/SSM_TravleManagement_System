...
<title>Order - TravelManagement</title>
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				Order <small>All orders</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="all-admin-index.html"><i
						class="fa fa-dashboard"></i> Home</a></li>
				<li><a href="all-order-manage-list.html">Order</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-2 title">Number of Tourists</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="出游人数"
							value="${orders.peopleCount}" readonly="readonly">
					</div>

					<div class="col-md-2 title rowHeight2x">Other</div>
			...
			<!--订单信息/--> <!--游客信息-->
			<div class="panel panel-default">
				<div class="panel-heading">Tourist Information</div>
				<!--数据列表-->
				<table id="dataList"
					...
					<thead>
						<tr>
							...
							<th class="">Number of certificate</th>
						</tr>
					</thead>
					<tbody>
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-2 title">Nickname</div>
			...
			<!--联系人信息/--> <!--费用信息--> <c:if test="${orders.orderStatus==1}">
				<div class="panel panel-default">
					<div class="panel-heading">Fare Information</div>
					<div class="row data-type">
						...
						<div class="col-md-4 data text">CAD${orders.product.productPrice}$</div>
