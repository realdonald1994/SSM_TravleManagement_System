...
<title>Authority - TravelManagement</title>
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				Authority Management <small>All Authorities</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> Home</a></li>
				<li><a
					href="${pageContext.request.contextPath}/role/findAll.do">Authority Management</a></li>

				<li class="active">All Authorities</li>
			</ol>
			</section>
			<!-- 内容头部 /-->
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_desc">Authority Name</th>
										<th class="sorting_asc sorting_asc_disabled">Authority Range</th>
									...
									<c:forEach items="${permissionList}" var="permission">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${permission.id}" class="btn bg-olive btn-xs">Add Authority</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
